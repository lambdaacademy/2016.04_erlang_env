...
Check that the web interface of Graphite is accessible on your *host machine* via web browser. Point it to http://192.169.1.100:8080 You should see a dashboard like the one below:
